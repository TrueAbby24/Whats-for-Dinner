...
public class NameSearchAdapter extends RecyclerView.Adapter<NameSearchAdapter.ViewHolder> {
    private List<String> mDataset;
    private Context mContext;

    public NameSearchAdapter(Context context, List<String> list) {
        mDataset = list;
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        NameSearchAdapter.ViewHolder vh = new NameSearchAdapter.ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(NameSearchAdapter.ViewHolder holder, int position) {
